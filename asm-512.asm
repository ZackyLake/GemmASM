...
unrollN_label:
    ...
    ; dp4a
    evex    vpdpbusd ymm14, ymm10, ymm0
    evex    vpdpbusd ymm13, ymm9, ymm0
    evex    vpdpbusd ymm12, ymm8, ymm0
    evex    vpdpbusd ymm11, ymm7, ymm0
    ; load wgt get hi
    prefetcht0 [rcx+200h]
    vmovups ymm10, ymmword ptr [rcx]
